...
Pipeline running at ${CONCOURSE_URL}/zookeeper-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml zookeeper-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml zookeeper-boshrelease-image --paused=false
```
